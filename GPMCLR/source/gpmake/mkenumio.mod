 ...
 *
 * input file  : mkenumio.mpp
 * time stamp  : 2004:01:12::06:26:00
 *
 * output file : mkenumio.mod
 * created at  : 2004:01:12::16:26:05
 *
 * options ... :  /Ddotnet86
 *
 * =======================================================
...
TYPE    TyNodeClass = (II, ZZ, UU, RR,
	...
	StdError.WriteCard(lexAtt.fixValue,0);
	StdError.WriteString(" should have been ");
	StdError.WriteCard(verNum,0);
	AbortMessage(' Sorry',"");
      END;
...
(**)  Check(eofSy); CloseSymFile();
  ...
  BEGIN
    ...
    StdError.WriteLn;
    StdError.WriteString("  <typename> must be the name of the enumeration type in the correct case");
    StdError.WriteLn;
    StdError.WriteString("  <modname> may be a ... ");
    StdError.WriteLn;
    StdError.WriteString("   * mixed case module name");
    StdError.WriteLn;
    StdError.WriteString("   * lower case module name");
    StdError.WriteLn;
    StdError.WriteString("   * filename (without extension)");
    StdError.WriteLn;
    StdError.WriteString("#MkEnumIO: Output files are ..."); StdError.WriteLn;
    StdError.WriteString("  <typename>io.def"); StdError.WriteLn;
    StdError.WriteString("  <typename>io.mod"); StdError.WriteLn;
    StdError.WriteString("  where <typename> is moved to lower case"); 
    StdError.WriteLn;
    StdError.WriteString("#MkEnumIO: switch: /c (case insensitive) match of input"); 
    StdError.WriteLn;
    StdError.WriteString("                   /i (input) procedures are created");
    StdError.WriteLn;
    StdError.WriteString("                   /n (no input) procedures");
    StdError.WriteLn;
    StdError.WriteString("                   /v (verbose) writes filenames to std output");
    StdError.WriteLn;
    StdError.WriteString("                   /x (exact) match of input");
    StdError.WriteLn;
    UNIXexit(1);
  END Usage;
...
BEGIN
  ...
  IF tNam[0] = "" THEN
    StdError.WriteString("#MkEnumIO: no type name given");
    StdError.WriteLn;
    Usage;
  END;
  ...
  IF NOT ok THEN 
    StdError.WriteString("symbol file for '");
    StdError.WriteString(str);
    StdError.WriteString("' not found");
    StdError.WriteLn;
    AbortMessage("","");
  ELSE 
    IF MoreRecent(hsh) THEN
      StdError.WriteString("#MkEnumIO: WARNING ");
      StdError.WriteString(str);
      StdError.WriteString(".def is more recent then ");
      StdError.WriteString(str);
      StdError.WriteString(".syx");
      StdError.WriteLn;
    END;
    typeFound := FALSE;
    ParseSymbolFile();
